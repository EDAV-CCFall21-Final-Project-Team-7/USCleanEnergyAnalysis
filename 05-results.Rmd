...
```{r, warning=F, echo=F, fig.heigh=8}
...
current_states$coal <- current_states$coal/current_states$total*100
current_states$renewables <- current_states$renewables/current_states$total*100
current_states$all_solar <- current_states$all_solar/current_states$total*100
current_states$wind <- current_states$wind/current_states$total*100
