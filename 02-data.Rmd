...
This dataset was pulled from the [EIA website](https://www.eia.gov/opendata/qb.php?category=1) through an API. There is a package in R called "eia" that helps automate data pulls from the EIA.gov API calls. We used this package to pull monthly power generation data by fuel type for all of the states in the USA from the time period of 2001 - 2021.
